...
document.addEventListener('click', function (event) {
    ...
    const headerNavContainerExpandedJournal = document.getElementsByClassName('header-nav-container--mobile-expanded-journal');
    if (headerNavContainerExpanded.length === 0
        ...
        } else if (document.getElementsByClassName('header-background-journal').length > 0) {
            // Journal Pages
            const headerBackground = document.getElementsByClassName('header-background-journal')[0];
            headerBackground.classList.add('header-background--mobile-expanded');
            headerNavContainer.classList.add('header-nav-container--mobile-expanded-journal');
        }
        ...
        if (document.getElementsByClassName('header-background').length > 0) {
            ...
            const headerBackground = document.getElementsByClassName('header-background-journal')[0];
            headerBackground.classList.remove('header-background--mobile-expanded');
            headerNavContainer.classList.remove('header-nav-container--mobile-expanded-journal');
        }
        const headerLinksContainer = document.getElementsByClassName('header-links-container')[0];
